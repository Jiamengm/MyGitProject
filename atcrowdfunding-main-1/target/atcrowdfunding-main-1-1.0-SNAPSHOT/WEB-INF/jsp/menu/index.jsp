<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <h4 class="modal-title" id="addModalLabel">添加菜单</h4>
    </div>
    ...
    <button id="updateBtn" type="button" class="btn btn-primary">修改</button>
        ...
        $.get("${PATH}/menu/loadTree",{},function(result) {
            zNodes = result;
            zNodes.push({"id":0,"name":"菜单树","icon":"glyphicon glyphicon-th-list","url":"main"}
            )
        ...
        function addHoverDom(treeId,treeNode) {
            ...
            s += '<a class="btn btn-info dropdown-toggle btn-xs" style="margin-left:10px;padding-top:0px;" onclick="delMenu('+treeNode.id+')" >  <i class="fa fa-fw fa-times rbg "></i></a>';
            }
            s += '<a class="btn btn-info dropdown-toggle btn-xs" style="margin-left:10px;padding-top:0px;" onclick="add('+treeNode.id+')"  >  <i class="fa fa-fw fa-plus rbg "></i></a>';
        ...
        function toUpdate(id) {
            ...
            $.get("${PATH}/menu/toUpdate",{id:id},function(result) {
         ...
         $("#updateBtn").click(function() {
            ...
            <%--$.post("${PATH}/menu/add",{pid:pid,name:name,icon:icon,url:url},function(result) {--%>
            $.post("${PATH}/menu/doUpdate",{id:id,name:name,icon:icon,url:url},function(result){
                if(result == 'ok'){
